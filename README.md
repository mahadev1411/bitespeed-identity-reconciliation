...
The service maintains a **Contact table** to store all contact entries.
...
1. Search the database for contacts matching the provided **email or phone number**.
...
4. If the request introduces new information (for example a new email or phone number), create a **secondary contact** linked to the primary identity.
5. If the email and phone number correspond to **two different identities**, the identities are merged. The **oldest contact remains the primary**, and the other is converted into a secondary contact.
